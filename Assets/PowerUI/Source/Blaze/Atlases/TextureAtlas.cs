...
namespace Blaze{
	...
	public class TextureAtlas{
		...
		public TextureAtlas():this(1024,FilterMode.Point,TextureFormat.ARGB32){}
		
		public TextureAtlas(int dimension):this(dimension,FilterMode.Point,TextureFormat.ARGB32){}
		...
		public TextureAtlas(int dimension,FilterMode filter,TextureFormat format){
			Dimension=dimension;
